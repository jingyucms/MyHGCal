...
if "PU200" in filename.split("_"):
    prefix = 'root://cmseos.fnal.gov//eos/uscms/store/user/zhangj/HGC/HDBSCAN/MyHDBSCAN/'
else:
    prefix = ''

print prefix+filename.replace("step1","step2")

# Input source
process.source = cms.Source("PoolSource",
    dropDescendantsOfDroppedBranches = cms.untracked.bool(False),
    fileNames = cms.untracked.vstring('file:'+prefix+filename.replace("step1","step2")),
